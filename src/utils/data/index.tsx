...
export const FOOTER_LINKS: Array<FooterLinks> = [
  {
    classNameContainer:
      'w-10 h-fit p-1 border border-black rounded-full bg-white transform transition duration-300 hover:scale-[1.01] hover:bg-lightblue hover:-translate-y-1',
  ...
  {
    classNameContainer:
      'w-10 h-fit p-1 border border-black rounded-full bg-white transform transition duration-300 hover:scale-[1.01] hover:bg-green hover:-translate-y-1',
  ...
  {
    classNameContainer:
      'w-10 h-fit p-1 border border-black rounded-full bg-white transform transition duration-300 hover:scale-[1.01] hover:bg-amber hover:-translate-y-1',
